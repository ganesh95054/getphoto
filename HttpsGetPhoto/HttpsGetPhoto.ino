...
const char *httpsHost = "raw.githubusercontent.com";// url server
const char *webPath =  "/Xinyuan-LilyGO/TTGO_TWatch_Library/master/examples/BasicUnit/HttpsGetPhoto/";// path file photo
...
#define wifi_ssid       "Stockton420" // your ssid WiFi
#define wifi_password   "Swamigal2409$" // your password WiFi
//---------------------------------------//
